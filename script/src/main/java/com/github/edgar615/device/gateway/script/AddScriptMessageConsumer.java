 ...
 */
public class AddScriptMessageConsumer implements Handler<Message<JsonObject>> {

  private static final Logger LOGGER = LoggerFactory.getLogger(AddScriptMessageConsumer.class);

  public AddScriptMessageConsumer(Vertx vertx, JsonObject config) {
  }
